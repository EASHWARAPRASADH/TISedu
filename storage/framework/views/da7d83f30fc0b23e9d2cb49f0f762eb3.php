...
<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backEnd/')); ?>/css/croppie.css">
    <style>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 mt-4">
                                                                <div class="primary_input ">
                                                                    ...
                                                                    <input class="primary_input_field form-control<?php echo e($errors->has('emis_id') ? ' is-invalid' : ''); ?>"
                                                                        type="text" name="emis_id" value="<?php echo e(old('emis_id')); ?>">
                                                                    <?php if($errors->has('emis_id')): ?>
                                                                        <span class="text-danger"><?php echo e($errors->first('emis_id')); ?></span>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                            <?php if(moduleStatusCheck('Lead') == true): ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 mt-4">
                                                                <div class="primary_input ">
                                                                    ...
                                                                    <input class="primary_input_field form-control<?php echo e($errors->has('siblings') ? ' is-invalid' : ''); ?>"
                                                                        type="text" name="siblings" value="<?php echo e(old('siblings')); ?>">
                                                                    <?php if($errors->has('siblings')): ?>
                                                                        <span class="text-danger"><?php echo e($errors->first('siblings')); ?></span>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                                                    ...
                                                                                    <div class="primary_input "
                                                                                        ...
                                                                                        <div class="pull-right loader loader_style"
                                                                                            ...
                                                                                            <img class="loader_img_style"
                                                                                                src="<?php echo e(asset('backEnd/img/demo_wait.gif')); ?>"
                                                                                                alt="loader">
                                                                                        </div>
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(asset('backEnd/js/croppie.js')); ?>"></script>
    <script src="<?php echo e(asset('backEnd/js/st_addmision.js')); ?>"></script>
    <script>
        ...
        $(document).ready(function() {
            let class_options = '';
            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                class_options += '<option value="<?php echo e($class->id); ?>"><?php echo e($class->class_name); ?></option>';
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u841409365/domains/test-technoprint.online/public_html/erpv2/resources/views/backEnd/studentInformation/student_admission.blade.php ENDPATH**/ ?>