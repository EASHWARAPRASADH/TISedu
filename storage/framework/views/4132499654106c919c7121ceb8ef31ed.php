...
<nav id="sidebar" class="sidebar">
    ...
    <?php if(Auth::user()->is_saas == 0): ?>
        ...
        <ul class="sidebar_menu list-unstyled" id="sidebar_menu">
            <?php if ($__env->exists('backEnd.menu.org_chart')) echo $__env->make('backEnd.menu.org_chart', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php if(moduleStatusCheck('Saas') == true &&
                Auth::user()->is_administrator == 'yes' &&
                Session::get('isSchoolAdmin') == false &&
                Auth::user()->role_id == 1): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u841409365/domains/test-technoprint.online/public_html/erpv2/resources/views/components/sidebar-component.blade.php ENDPATH**/ ?>