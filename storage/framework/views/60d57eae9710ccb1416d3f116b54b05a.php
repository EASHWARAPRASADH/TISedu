...
<link rel="stylesheet" href="<?php echo e(asset('backEnd/vendors/font_awesome/css/all.min.css')); ?>" />
<link rel="stylesheet" href="<?php echo e(asset('backEnd/vendors/themefy_icon/themify-icons.css')); ?>" />
<link rel="stylesheet" href="<?php echo e(asset('backEnd/vendors/css/flaticon.css')); ?>" />
<link rel="stylesheet" href="<?php echo e(asset('backEnd/vendors/css/fnt.min.css')); ?>" />
...
<?php if(userRtlLtl() ==1): ?>
    <link rel="stylesheet" href="<?php echo e(asset('backEnd/assets/css/rtl/bootstrap.rtl.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('backEnd/assets/css/global_rtl.css')); ?>">
<?php else: ?>
...
<link rel="stylesheet" href="<?php echo e(asset('whatsapp-support/style.css')); ?>">
<?php endif; ?> 
<?php if(\Request::route()->getName() == "fees.fees-invoice-settings"): ?>
<link rel="stylesheet" href="<?php echo e(asset('backEnd/vendors/select2/css/select2.min.css')); ?>" />
<?php endif; ?> 
...
<?php endif; ?>
    ...
    <script src="<?php echo e(asset('backEnd/')); ?>/vendors/js/jquery-3.2.1.min.js"></script>
    <script>
        window.Laravel = {
...
<?php /**PATH /home/u841409365/domains/test-technoprint.online/public_html/erpv2/resources/views/backEnd/partials/header.blade.php ENDPATH**/ ?>