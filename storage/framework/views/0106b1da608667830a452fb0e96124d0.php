...
<head>
    ...
    <meta name="description" content="SuperAdmin Panel - InfixEdu ERP">
    <title>SuperAdmin Login - InfixEdu</title>
...
<div class="login-container">
    <div class="login-card">
        ...
        <form method="POST" action="<?php echo e(route('superadmin.login.submit')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="footer-text">
        &copy; <?php echo e(date('Y')); ?> InfixEdu • SuperAdmin Panel
    </div>
</div>

<!-- Scripts -->
<script src="<?php echo e(asset('public/backEnd/login')); ?>/js/jquery-3.3.1.slim.min.js"></script>
<script src="<?php echo e(asset('public/backEnd/login')); ?>/js/bootstrap.min.js"></script>

</body>
</html>
<?php /**PATH /Users/eash/Downloads/erpv2 2/resources/views/auth/superadmin_login.blade.php ENDPATH**/ ?>