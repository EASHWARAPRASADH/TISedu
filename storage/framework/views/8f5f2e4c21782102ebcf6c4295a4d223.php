            ...
            <?php if($custom_field->type == 'textInput'): ?>
                <div class="<?php echo e($custom_field->width); ?>">
                    <div class="primary_input ">
                        ...
                        <input
                            class="primary_input_field form-control<?php echo e($errors->has('customF.'.$input_name) ? ' is-invalid' : ''); ?>"
                            type="text"
                            name="customF[<?php echo e($input_name); ?>]"
                            value="<?php echo e(isset($student) ? customFieldValue($student->id, $custom_field->label, $student->custom_field_form_name) : ''); ?>">
                        
                        <?php if($errors->has('customF.'.$input_name)): ?>
                            <span class="text-danger">
                                <?php echo e(str_replace('custom f.', '', $errors->first('customF.'.$input_name))); ?></strong>
                            </span>
                        <?php endif; ?>
                    </div>
                </div>
            <?php elseif($custom_field->type == 'numericInput'): ?>
                ...
                <div class="<?php echo e($custom_field->width); ?>">
                    <div class="primary_input ">
                        ...
                        <input
                            class="primary_input_field form-control<?php echo e($errors->has($input_name) ? ' is-invalid' : ''); ?>"
                ...
                <div class="<?php echo e($custom_field->width); ?>">
                    <div class="primary_input ">
                        ...
                        <textarea class="primary_input_field form-control" cols="0" rows="3"
                            name="customF[<?php echo e($input_name); ?>]"><?php echo e(isset($student) ? customFieldValue($student->id, $custom_field->label, $student->custom_field_form_name) : ''); ?></textarea>
                    ...
                    <div class="no-gutters input-right-icon">
                        <div class="col">
                            <div class="primary_input ">
                                ...
                                <input
                                    class="primary_input_field date form-control<?php echo e($errors->has($input_name) ? ' is-invalid' : ''); ?>"
                    ...
                    <div class="d-flex radio-btn-flex ml-40">
                        <?php if($name_values): ?>
                            <?php $__currentLoopData = $name_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mr-30">
                                    <input type="radio" name="customF[<?php echo e($input_name); ?>]"
            ...
            <?php elseif($custom_field->type == 'dropdownInput'): ?>
                ...
                <div class="<?php echo e($custom_field->width); ?>">
                    <div class="primary_input ">
                        ...
                        <select class="primary_select  form-control<?php echo e($errors->has($input_name) ? ' is-invalid' : ''); ?>"
                            name="customF[<?php echo e($input_name); ?>]">
                            <option
                        ...
                        <?php if($errors->has('customF.'.$input_name)): ?>
                            <span class="text-danger">
                                <?php echo e(str_replace('custom field', '', $errors->first('customF.'.$input_name))); ?></strong>
                            </span>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="row no-gutters input-right-icon">
                        <div class="col">
                            <div class="primary_input ">
                                ...
                                <?php if($errors->has($input_name)): ?>
                                    <span class="text-danger d-block">
                                        <strong><?php echo e(@$errors->first($input_name)); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php endif; ?>
<?php echo $__env->make('backEnd.partials.date_picker_css_js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u841409365/domains/test-technoprint.online/public_html/erpv2/resources/views/backEnd/studentInformation/_custom_field.blade.php ENDPATH**/ ?>