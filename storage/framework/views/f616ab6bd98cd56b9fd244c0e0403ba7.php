...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
    <div class="sa-card" style="text-align: center;">
        ...
        <div style="display: flex; gap: 8px; justify-content: center;">
            <a href="<?php echo e(route('superadmin.reports.schools')); ?>" class="sa-btn sa-btn-primary"><i class="fas fa-eye"></i> View</a>
            <a href="<?php echo e(route('superadmin.reports.schools.export')); ?>" class="sa-btn sa-btn-outline"><i class="fas fa-download"></i> CSV</a>
        </div>
    </div>
    ...
    <div class="sa-card" style="text-align: center;">
        ...
        <a href="<?php echo e(route('superadmin.analytics.index')); ?>" class="sa-btn sa-btn-primary"><i class="fas fa-chart-bar"></i> View Analytics</a>
    </div>
    ...
    <div class="sa-card" style="text-align: center;">
        ...
        <a href="<?php echo e(route('superadmin.audit.index')); ?>" class="sa-btn sa-btn-primary"><i class="fas fa-list"></i> View Logs</a>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('backEnd.superAdmin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eash/Downloads/erpv2 2/resources/views/backEnd/superAdmin/reports/index.blade.php ENDPATH**/ ?>