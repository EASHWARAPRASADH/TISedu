            ...
            <div class="header_iner d-flex justify-content-between align-items-center">
                <div class="small_logo_crm d-lg-none">
                    <a href="#">
                        ...
                        <?php else: ?>
                            <img src="<?php echo e(asset('uploads/settings/logo.png')); ?>" alt="logo">
                        <?php endif; ?>
                    </a>
                </div>
                ...
                <div class="header_right d-flex justify-content-between align-items-center">
                    ...
                    <ul class="header_notification_warp d-flex align-items-center">
                        ...
                        <li class="scroll_notification_list">
                            <a class="pulse theme_color bell_notification_clicker show_notifications" href="#">
                                <!-- bell   -->
                                <img src="<?php echo e(asset('backEnd/assets/img/icons/notification.svg')); ?>" alt="">
                        ...
                        <div class="select_style d-flex">
                            <?php if(generalSetting()->website_btn == 1): ?>
                                <a target="_blank" class=" mr-10 tab_hide"
                                    href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('backEnd/assets/img/icons/globe.svg')); ?>" alt=""></a>
                            <?php endif; ?>
                            
                            <?php if(generalSetting()->report_btn == 1): ?>
                                <?php if(Auth::user()->role_id == $coltroller_role): ?>
                                    <a class="mr-10 tab_hide"
                                        href="<?php echo e(route('student_report')); ?>"><img src="<?php echo e(asset('backEnd/assets/img/icons/report.svg')); ?>" alt=""></a>
                                <?php endif; ?>
                            <?php endif; ?>
                    ...
                    <div class="profile_info">
                        ...
                        <div class="user_avatar_div">
                            <img id="profile_pic"
                                src="<?php echo e(@profile() && file_exists(@profile()) ? asset(profile()) : asset('backEnd/assets/img/avatar.png')); ?>"
                                alt="">
                        </div>
                            ...
                            <div class="profile_info_details">
                                ...
                                <?php if(Auth::user()->role_id == '2' && Auth::user()->is_saas == 0): ?>
                                    <a href="<?php echo e(route('student-profile')); ?>">
                                        <img src="<?php echo e(asset('backEnd/assets/img/icons/profile.svg')); ?>" class="mr-1" alt="">
                                ...
                                <?php elseif(Auth::user()->role_id != '3' && Auth::user()->is_saas == 0 && Auth::user()->staff): ?>
                                    <a href="<?php echo e(route('viewStaff', Auth::user()->staff->id)); ?>">
                                        <img src="<?php echo e(asset('backEnd/assets/img/icons/profile.svg')); ?>" alt="">
                                        <?php echo app('translator')->get('common.view_profile'); ?>
                                ...
                                <?php if(!config('app.app_sync') && auth()->user()->role_id != 1): ?>
                                    <?php if(auth()->user()->staff && auth()->user()->staff->parent_id && auth()->user()->role_id == 3): ?>
                                        <a href="<?php echo e(route('viewAsRole')); ?>">
                                            ...
                                            <img src="<?php echo e(asset('backEnd/assets/img/icons/key.svg')); ?>" alt="" class="mr-1">
                                ...
                                <?php if(moduleStatusCheck('Saas') == true &&
                                    ...
                                    <a href="<?php echo e(route('viewAsSuperadmin')); ?>">
                                        <img src="<?php echo e(asset('backEnd/assets/img/icons/key.svg')); ?>" alt="">
                                ...
                                <a href="<?php echo e(route('updatePassowrd')); ?>">
                                    <img src="<?php echo e(asset('backEnd/assets/img/icons/password.svg')); ?>" alt="">
                                ...
                                <a href="<?php echo e(Auth::user()->role_id == 2 ? route('student-logout') : route('logout')); ?>"
                                    ...
                                    <img src="<?php echo e(asset('backEnd/assets/img/icons/logout.svg')); ?>" alt="">
...
<?php /**PATH /home/u841409365/domains/test-technoprint.online/public_html/erpv2/resources/views/backEnd/partials/menu.blade.php ENDPATH**/ ?>