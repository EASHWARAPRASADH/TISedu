...
<div class="sa-card" style="max-width: 700px;">
    <div class="sa-card-header">
        <span class="sa-card-title">Create New School</span>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="sa-form-group">
                    ...
                    <input type="text" name="school_name" class="sa-form-control" value="{{ old('school_name') }}" required>
            ...
            <div class="col-md-6">
                <div class="sa-form-group">
                    ...
                    <input type="text" name="phone" class="sa-form-control" value="{{ old('phone') }}">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="sa-form-group">
                    ...
                    <div style="display: flex; align-items: center; background: rgba(0,0,0,0.2); border-radius: 8px; border: 1px solid rgba(255,255,255,0.08); overflow: hidden;">
                        <input type="text" name="domain" class="sa-form-control" value="{{ old('domain') }}" required style="border: none; border-radius: 0; background: transparent; padding-right: 5px; text-align: right;" placeholder="schoolname">
            ...
            <div class="col-md-6">
                <div class="sa-form-group">
                    ...
                    <input type="text" name="custom_domain" class="sa-form-control" value="{{ old('custom_domain') }}" placeholder="e.g., erp.myschool.com">
            ...
            <div class="col-md-12">
                <div class="sa-form-group">
                    ...
                    <textarea name="address" class="sa-form-control" rows="3">{{ old('address') }}</textarea>
                </div>
            </div>
        </div>
        <div style="display: flex; gap: 12px; margin-top: 12px;">
            <button type="submit" class="sa-btn sa-btn-primary"><i class="fas fa-save"></i> Create School</button>
