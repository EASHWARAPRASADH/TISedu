...
@if(userPermission('automatedtimetable.editor') || userPermission('automatedtimetable.rules'))
<li class="main {{ spn_active_link(['automatedtimetable.editor', 'automatedtimetable.rules'], 'mm-active') }}">
    ...
    <ul class="list-unstyled mm-collapse">
        @if(userPermission('automatedtimetable.editor'))
        <li>
            <a href="{{ route('automatedtimetable.editor') }}">
                <div class="nav_icon_small">
        ...
        @endif
        @if(userPermission('automatedtimetable.rules'))
        <li>
            <a href="{{ route('automatedtimetable.rules') }}">
                <div class="nav_icon_small">
