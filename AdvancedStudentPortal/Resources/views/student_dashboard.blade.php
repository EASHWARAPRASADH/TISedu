        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="white-box student-details text-center mb-30">
                    <img src="{{ isset($student) && file_exists($student->student_photo) ? asset($student->student_photo) : asset('uploads/staff/demo/staff.jpg') }}" class="rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">
